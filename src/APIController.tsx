...
import {ProjectType, ImageType} from "./interfaces/ProjectInterface"
...
const APIController = (() => {
  ...
  var _searchForProjects = async (token :string, searchTerms :string, projectArray: ProjectType[]) => {
    projectArray = [];
    ...
    projectDataJson.projects.forEach((projectEl: any) => {
  ...
  // const _getProjectDetails = async (token: string, projectEndPoint: string, projectArray: ProjectType[]) => {
  ...
  //   await data.projects.items.forEach((projectEl: any) => {
  ...
  return {
    ...
    getToken() {
      console.log("_getToken being called");
      return _getToken();
    },
    async searchForProjects(token: string, searchTerms: string, projectArray: ProjectType[]) {
      return _searchForProjects(token, searchTerms, projectArray);
    },
    // getProjectDetails(token: string, projectEndPoint: string) {
    //   return _getProjectDetails(token, projectEndPoint, projectArray: ProjectType[]);
    // },
  };
})();
